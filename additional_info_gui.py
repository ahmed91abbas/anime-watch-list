...
class AdditionalInfoGUI():
    ...
    def create_gui(self, raw_image_data):
        ...
        self.synopsis_text_widget = tk.Text(info_free_text_frame, font=label_config['font'], wrap='word', width=width,
            height=height, bg=bg_color, highlightthickness=0, borderwidth=0)
